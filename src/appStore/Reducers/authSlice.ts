...
export const login_With_Email_Password_Async = createAsyncThunk(
    ...
    async (emailPassword:email_Password_for_login, thunkAPI) => {
        try {
            ...
            console.log("emailPassword.email: at[login_With_Email_Password_Async]", emailPassword.email);
            console.log("emailPassword.password: : at[login_With_Email_Password_Async] ", emailPassword.password);
...
const authSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(login_With_Email_Password_Async.pending, (state) => {
            state.apiInovocatoinStatus = 'loading';

        }).
        addCase(login_With_Email_Password_Async.rejected, (state, action) => {
        ...
        addCase(login_With_Email_Password_Async.fulfilled, (state, action) => {
